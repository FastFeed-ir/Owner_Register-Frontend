...
import '../entity/subscription_model.dart';
...
class SubscriptionRepositoryImpl extends SubscriptonRepository {
  var dio = Dio(options);
  @override
  Future<List<SubscriptionModel>> getSubscription(int businessOwnerId) async {
    var response =
    await dio.get('subscriptions/?business_owner=$businessOwnerId');
    print(
